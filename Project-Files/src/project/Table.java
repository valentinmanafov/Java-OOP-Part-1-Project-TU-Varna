...
public class Table {
    ...
    public Table(String name, List<Column> columns) {
        ...
        if (columns == null) throw new IllegalArgumentException("ERROR: Column list cannot be null.");
        this.name = name;
    ...
    public Table(String name, List<Column> columns, List<Row> rows) {
        this(name, columns);
        if (rows == null) throw new IllegalArgumentException("ERROR: Row list cannot be null.");
    ...
    public void setRows(List<Row> newRows) {
        if (newRows == null) throw new IllegalArgumentException("ERROR: New row list cannot be null.");
    ...
    public Column getColumn(int index) throws DatabaseOperationException {
        ...
        throw new DatabaseOperationException("ERROR: Column index " + index + " is out of bounds for table '" + name + "'.");
    }
