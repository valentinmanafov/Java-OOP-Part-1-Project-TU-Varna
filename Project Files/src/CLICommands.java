...
public class CLICommands {
    ...
    public void handleHelp(String[] args) {
        ...
        System.out.println("import <file>          - Import table from file (Not Implemented)");
    ...
    public void handleAggregate(String[] args) {
        try {
            if (args.length != 5) {
    ...
    public void handleCreateTable(String[] args) {
        try {
    ...
    public void handleInnerJoin(String[] args) {
        try {
            if (args.length != 4) {
    ...
    public void handleImport(String[] args) { notImplemented("import (file reading not supported in this version)"); }
